<template>
    <div >
        <v-pageTitle vtitle="TotalBoard"></v-pageTitle>
        ...
        <el-row :gutter="20">
              <el-col :xs="24" :sm="24" :md="8" :lg="8">
                 <p style="text-align:center;">OEE损失（数量/件）</p>
             ...
             <el-col :xs="24" :sm="24" :md="8" :lg="8">
                 <p style="text-align:center;">每日抽检合格率</p>
                <borderTable1></borderTable1>
            ...
            <el-col :xs="24" :sm="24" :md="8" :lg="8">
                 <p style="text-align:center;">入库吨数对比</p>
...
<script>
    ...
    import borderTable1 from '../tables/borderTable1.vue'
    import storageTable from'../tables/storageTable.vue'
    ...
    export default {
        ...
        components:{
            vPageTitle,barChart,pieChart,lineChart,radarChart,funnelChart,TodoList,borderTable,MessageList,borderTable1,storageTable,storageChart
        }
    }
</script>
